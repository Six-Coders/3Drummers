...
from onsets_frames_transcription.tools.contrib import rnn as contrib_rnn
...
import onsets_frames_transcription.tools.estimator_spec_util as estimator_spec_util
