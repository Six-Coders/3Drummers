...
namespace UIPerso
{
    public class UIPerso : VisualElement
    {
        ...
        public UIPerso()
        {
            ...
            float increaseHeight = 80; // Ajusta el valor seg�n tus necesidades

            // Obt�n la posici�n Y actual del elemento
            float currentY = window.resolvedStyle.top;

            // Aumenta la altura del elemento hacia arriba ajustando la posici�n Y
            ...
            // Establece el estilo de la fuente y el tama�o de fuente
            checkToggle.style.fontSize = 25; // Elige el tama�o de fuente que desees
            checkToggle.style.color = new StyleColor(Color.white);

            checkToggle.value = PlayerPrefs.GetInt(PlayerPrefsKeyBombo) == 1;
            Debug.Log(PlayerPrefs.GetInt(PlayerPrefsKeyBombo));
            ...
            // Establece el estilo de la fuente y el tama�o de fuente
            checkToggle2.style.fontSize = 25; // Elige el tama�o de fuente que desees
            ...
            // Establece el estilo de la fuente y el tama�o de fuente
            checkToggle3.style.fontSize = 25; // Elige el tama�o de fuente que desees
            ...
            // Establece el estilo de la fuente y el tama�o de fuente
            checkToggle5.style.fontSize = 25; // Elige el tama�o de fuente que desees
            ...
            // Establece el estilo de la fuente y el tama�o de fuente
            checkToggle4.style.fontSize = 25; // Elige el tama�o de fuente que desees
            ...
            // Establece el estilo de la fuente y el tama�o de fuente
            checkToggle6.style.fontSize = 25; // Elige el tama�o de fuente que desees
            ...
            // Crear el contenedor para el bot�n "Cambiar Orientacion"
            ...
            // Crear el contenedor para el bot�n "Accept"
...

        {
            ...
            Transform drumZurda = DrumZurda.transform; // Aseg�rate de que DrumZurda sea un GameObject accesible
